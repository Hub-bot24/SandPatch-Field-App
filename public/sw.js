...
// offline on the very first export/calibration - not only after the
// relevant screen has successfully fetched them once online.
const STATIC_PRECACHE_URLS = [
  "/templates/sand-patch-master.xlsx",
